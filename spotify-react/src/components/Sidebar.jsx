...
import { searchSong } from '../action/index';

const mapStateToProps = (state) => ({
	searchList: state.search.searchSong,
});

const mapDispatchToProps = (dispatch) => ({
	searchSong: (text) => {
		dispatch(searchSong(text));
	},
});

const Sidebar = ({ searchSong, searchList }) => {
		...
		<div className="col-2">
			...
			>
				<div className="nav-container">
					...
					>
						<span className="navbar-toggler-icon">go</span>
					</button>
